...
TEST='./conf -f hash.json glossary.title glossary.GlossDiv.GlossList.1 glossary.GlossDiv.GlossList.2=yyy'

echo ${TEST}
${TEST}

echo "Tree overwrite, should ignore while user delete childs"
TEST='./conf -f hash.json glossary.GlossDiv.GlossList.0=yyy'
