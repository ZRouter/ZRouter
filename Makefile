...
.if !exists(/usr/local/bin/perl) || !exists(/usr/local/bin/dialog4ports)
.error "ports need perl and dialog4ports command. Please install to perl and dialog4ports command"
.endif
