...
make TARGET_VENDOR=D-Link TARGET_DEVICE=DIR-620 FREEBSD_SRC_TREE=${FREEBSD_SRC_TREE} TARGET_PROFILES="SMALL_ mpd" kernel-install kernel.oldlzma.uboot world-build world-install rootfs.iso.ulzma 2>&1 | tee $0.${DATE}.log
