...
make TARGET_VENDOR=D-Link TARGET_DEVICE=DIR-320 FREEBSD_SRC_TREE=${FREEBSD_SRC_TREE} TARGET_PROFILES="SMALL_ zhttpd" kernel-build kernel-install rootfs kernel_bin_gz_trx rootfs.iso.ulzma 2>&1 | tee $0.${DATE}.log
