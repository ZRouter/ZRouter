...
KERNCONF_IDENT?=	MT7621
KERNCONF_CPU=		CPU_MIPS1004K
KERNCONF_FILES+=	"../mediatek/files.mediatek"

KERNCONF_HINTS=		"MT7621.hints"
...
KERNCONF_OPTIONS+=      CD9660
KERNCONF_OPTIONS+=      GEOM_UZIP
KERNCONF_OPTIONS+=	SCSI_DELAY=1000

KERNCONF_OPTIONS+=      MD_ROOT
KERNCONF_DEVICES+=	md

KERNCONF_DEVICES+=	mtk_intr_gic

# SPI and SPI flash support
KERNCONF_DEVICES+=      mtk_spi_v2
KERNCONF_DEVICES+=      spibus
KERNCONF_DEVICES+=      mx25l

# GPIO and gpioled support
KERNCONF_DEVICES+=      mtk_gpio_v2
...
KERNCONF_OPTIONS+=	IF_RT_RING_DATA_COUNT=256
